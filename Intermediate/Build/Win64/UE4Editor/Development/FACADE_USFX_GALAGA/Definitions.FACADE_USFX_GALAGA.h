...
#define UE_PROJECT_NAME FACADE_USFX_GALAGA
#define UE_TARGET_NAME FACADE_USFX_GALAGAEditor
#define UE_MODULE_NAME "FACADE_USFX_GALAGA"
...
#define FACADE_USFX_GALAGA_API DLLEXPORT
